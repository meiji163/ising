...
var G__10335 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10335,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10335;
}
}));
...
var len__4864__auto___10340 = arguments.length;
var i__4865__auto___10341 = (0);
while(true){
if((i__4865__auto___10341 < len__4864__auto___10340)){
args__4870__auto__.push((arguments[i__4865__auto___10341]));

var G__10342 = (i__4865__auto___10341 + (1));
i__4865__auto___10341 = G__10342;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10337){
var G__10338 = cljs.core.first.call(null,seq10337);
var seq10337__$1 = cljs.core.next.call(null,seq10337);
var G__10339 = cljs.core.first.call(null,seq10337__$1);
var seq10337__$2 = cljs.core.next.call(null,seq10337__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10338,G__10339,seq10337__$2);
}));
...
var map__10344 = m;
var map__10344__$1 = cljs.core.__destructure_map.call(null,map__10344);
var file = cljs.core.get.call(null,map__10344__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10344__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10344__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__10343_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10343_SHARP_));
...
var temp__5720__auto___10345 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10345)){
var message_10346 = temp__5720__auto___10345;
cljs.core.println.call(null,message_10346);
} else {
}
...
var temp__5720__auto___10347 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10347)){
var message_10348 = temp__5720__auto___10347;
cljs.core.println.call(null,message_10348);
} else {
}
...
var output_dir__$1 = (function (){var G__10349 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10349,"/"].join('');
} else {
return G__10349;
}
})();
...
var G__10350 = exception.stack;
var G__10350__$1 = (((G__10350 == null))?null:clojure.string.split_lines.call(null,G__10350));
var G__10350__$2 = (((G__10350__$1 == null))?null:cljs.core.get.call(null,G__10350__$1,depth));
if((G__10350__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10350__$2);
}
} else {
...
var vec__10351 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10351,(0),null);
var column = cljs.core.nth.call(null,vec__10351,(1),null);
var vec__10354 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10354,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10354,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10354,(2),null);
...
var m__$1 = (function (){var G__10357 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10361 = (function (){var G__10360 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10360);
} else {
return G__10360;
}
})();
...
return cljs.core.vary_meta.call(null,G__10362,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__10364 = e;
var G__10364__$1 = (((G__10364 instanceof cljs.core.Keyword))?G__10364.fqn:null);
switch (G__10364__$1) {
...
var vec__10366 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10366,(0),null);
var types = vec__10366;
...
return cljs.core.map.call(null,(function (p__10369){
var vec__10370 = p__10369;
var ns = cljs.core.nth.call(null,vec__10370,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10370,(1),null);
return (function (){
...
var G__10373 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__10374 = cljs.core.seq.call(null,vars__$1);
var chunk__10375 = null;
var count__10376 = (0);
var i__10377 = (0);
while(true){
if((i__10377 < count__10376)){
var v = cljs.core._nth.call(null,chunk__10375,i__10377);
var temp__5720__auto___10379 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10379)){
var t_10380 = temp__5720__auto___10379;
each_fixture_fn.call(null,((function (seq__10374,chunk__10375,count__10376,i__10377,t_10380,temp__5720__auto___10379,v,each_fixture_fn,G__10373,G__10373__$1,env,once_fixtures,each_fixtures,vec__10370,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10380)));
});})(seq__10374,chunk__10375,count__10376,i__10377,t_10380,temp__5720__auto___10379,v,each_fixture_fn,G__10373,G__10373__$1,env,once_fixtures,each_fixtures,vec__10370,ns,vars__$1))
);
} else {
}


var G__10381 = seq__10374;
var G__10382 = chunk__10375;
var G__10383 = count__10376;
var G__10384 = (i__10377 + (1));
seq__10374 = G__10381;
chunk__10375 = G__10382;
count__10376 = G__10383;
i__10377 = G__10384;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__10374);
if(temp__5720__auto__){
var seq__10374__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10374__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__10374__$1);
var G__10385 = cljs.core.chunk_rest.call(null,seq__10374__$1);
var G__10386 = c__4679__auto__;
var G__10387 = cljs.core.count.call(null,c__4679__auto__);
var G__10388 = (0);
seq__10374 = G__10385;
chunk__10375 = G__10386;
count__10376 = G__10387;
i__10377 = G__10388;
continue;
} else {
var v = cljs.core.first.call(null,seq__10374__$1);
var temp__5720__auto___10389__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10389__$1)){
var t_10390 = temp__5720__auto___10389__$1;
each_fixture_fn.call(null,((function (seq__10374,chunk__10375,count__10376,i__10377,t_10390,temp__5720__auto___10389__$1,v,seq__10374__$1,temp__5720__auto__,each_fixture_fn,G__10373,G__10373__$1,env,once_fixtures,each_fixtures,vec__10370,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10390)));
});})(seq__10374,chunk__10375,count__10376,i__10377,t_10390,temp__5720__auto___10389__$1,v,seq__10374__$1,temp__5720__auto__,each_fixture_fn,G__10373,G__10373__$1,env,once_fixtures,each_fixtures,vec__10370,ns,vars__$1))
);
} else {
}


var G__10391 = cljs.core.next.call(null,seq__10374__$1);
var G__10392 = null;
var G__10393 = (0);
var G__10394 = (0);
seq__10374 = G__10391;
chunk__10375 = G__10392;
count__10376 = G__10393;
i__10377 = G__10394;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10373__$1)].join('')));
