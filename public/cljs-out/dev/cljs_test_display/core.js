...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_10425);
...
var len__4864__auto___10429 = arguments.length;
var i__4865__auto___10430 = (0);
while(true){
if((i__4865__auto___10430 < len__4864__auto___10429)){
args__4870__auto__.push((arguments[i__4865__auto___10430]));

var G__10431 = (i__4865__auto___10430 + (1));
i__4865__auto___10430 = G__10431;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10426){
var G__10427 = cljs.core.first.call(null,seq10426);
var seq10426__$1 = cljs.core.next.call(null,seq10426);
var G__10428 = cljs.core.first.call(null,seq10426__$1);
var seq10426__$2 = cljs.core.next.call(null,seq10426__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10427,G__10428,seq10426__$2);
}));
...
var vec__10432 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10432,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10432,(1),null);
var G__10435 = cljs.core.PersistentArrayMap.EMPTY;
var G__10435__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10435,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10435);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10435__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10435__$1;
}
} else {
...
return (function() { 
var G__10439__delegate = function (klass,contents){
var vec__10436 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10436,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10436,(1),null);
...
var G__10439 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__10440__i = 0, G__10440__a = new Array(arguments.length -  1);
while (G__10440__i < G__10440__a.length) {G__10440__a[G__10440__i] = arguments[G__10440__i + 1]; ++G__10440__i;}
  contents = new cljs.core.IndexedSeq(G__10440__a,0,null);
} 
return G__10439__delegate.call(this,klass,contents);};
G__10439.cljs$lang$maxFixedArity = 1;
G__10439.cljs$lang$applyTo = (function (arglist__10441){
var klass = cljs.core.first(arglist__10441);
var contents = cljs.core.rest(arglist__10441);
return G__10439__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10445){
var map__10446 = p__10445;
var map__10446__$1 = cljs.core.__destructure_map.call(null,map__10446);
var ns = cljs.core.get.call(null,map__10446__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10446__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10447){
var map__10448 = p__10447;
var map__10448__$1 = cljs.core.__destructure_map.call(null,map__10448);
var actual = cljs.core.get.call(null,map__10448__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10448__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10449){
var map__10450 = p__10449;
var map__10450__$1 = cljs.core.__destructure_map.call(null,map__10450);
var expected = cljs.core.get.call(null,map__10450__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10450__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__10451_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__10451_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10453 = cljs_test_display.core.current_var_info.call(null);
var map__10453__$1 = cljs.core.__destructure_map.call(null,map__10453);
var info = map__10453__$1;
var name = cljs.core.get.call(null,map__10453__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10453__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10453__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__10452_SHARP_){
return cljs.core.cons.call(null,node,p1__10452_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10454){
var map__10455 = p__10454;
var map__10455__$1 = cljs.core.__destructure_map.call(null,map__10455);
var m = map__10455__$1;
var fail = cljs.core.get.call(null,map__10455__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10455__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10455__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10455__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___10456 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10456)){
var message_10457 = temp__5720__auto___10456;
cljs.core.println.call(null,message_10457);
} else {
}
...
var temp__5720__auto___10458 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10458)){
var message_10459 = temp__5720__auto___10458;
cljs.core.println.call(null,message_10459);
} else {
}
