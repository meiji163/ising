...
var o11343 = temp__5718__auto__;
var temp__5718__auto____$1 = (o11343["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11344 = temp__5718__auto____$1;
return (o11344["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10701__auto__ = f;
return (o__10701__auto__["toString"]).call(o__10701__auto__);
} else {
return "";
}
}catch (e11345){var _ = e11345;
return "";
}});
...
try{var o__10701__auto___11347 = t;
(o__10701__auto___11347["cljs$lang$ctorPrWriter"]).call(o__10701__auto___11347,t,writer);
}catch (e11346){var __11348 = e11346;
}
...
var char_code = (function (){var o__10701__auto__ = (new String(char$));
return (o__10701__auto__["charCodeAt"]).call(o__10701__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10701__auto__ = String;
return (o__10701__auto__["fromCharCode"]).call(o__10701__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11349 = num_code;
switch (G__11349) {
case (1):
return (185);
...
var o__10701__auto__ = String;
return (o__10701__auto__["fromCharCode"]).call(o__10701__auto__,superscript_code);
});
/**
...
}catch (e11351){var _e__10708__auto__ = e11351;
return false;
}})())){
...
var vec__11352 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11352,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11357){
var vec__11358 = p__11357;
var ns_detector = cljs.core.nth.call(null,vec__11358,(0),null);
...
var G__11364 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11365 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11364;
remaining_tokens = G__11365;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11355){
var G__11356 = cljs.core.first.call(null,seq11355);
var seq11355__$1 = cljs.core.next.call(null,seq11355);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11356,seq11355__$1);
}));
...
var vec__11369 = cljs.core.split_with.call(null,(function (p1__11368_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11368_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11369,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11369,(1),null);
...
var vec__11375 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11375,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11375,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11378 = cljs.core.rest.call(null,remaining_tokens);
var G__11379 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11378;
name_tokens = G__11379;
continue;
} else {
...
var vec__11382 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11382,(0),null);
var arity = cljs.core.nth.call(null,vec__11382,(1),null);
var vec__11385 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11385,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11385,(1),null);
var vec__11388 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11388,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11388,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11388,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11388,(3),null);
...
var vec__11394 = result;
var munged_ns = cljs.core.nth.call(null,vec__11394,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11394,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11394,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11394,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11394,(4),null);
var arity = cljs.core.nth.call(null,vec__11394,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__11398 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__11398,(0),null);
var args = cljs.core.nth.call(null,vec__11398,(1),null);
var vec__11401 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11401,(0),null);
var name = cljs.core.nth.call(null,vec__11401,(1),null);
...
var G__11404 = (arity + (1));
var G__11405 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11406){
var vec__11407 = p__11406;
var arity = cljs.core.nth.call(null,vec__11407,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11407,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11410_SHARP_){
return cljs.core.get.call(null,arities,p1__11410_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__11411_SHARP_){
return cljs.core.drop.call(null,(2),p1__11411_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___11418 = arguments.length;
var i__4865__auto___11419 = (0);
while(true){
if((i__4865__auto___11419 < len__4864__auto___11418)){
args__4870__auto__.push((arguments[i__4865__auto___11419]));

var G__11420 = (i__4865__auto___11419 + (1));
i__4865__auto___11419 = G__11420;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11414){
var vec__11415 = p__11414;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11415,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11412){
var G__11413 = cljs.core.first.call(null,seq11412);
var seq11412__$1 = cljs.core.next.call(null,seq11412);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11413,seq11412__$1);
}));
...
var map__11423 = options;
var map__11423__$1 = cljs.core.__destructure_map.call(null,map__11423);
var include_ns_QMARK_ = cljs.core.get.call(null,map__11423__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11423__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11423__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11423__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11424 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11424,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11424,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11424,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11424,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11424,(4),null);
var arity = cljs.core.nth.call(null,vec__11424,(5),null);
...
var o__10701__auto__ = f;
return (o__10701__auto__["getBasis"]).call(o__10701__auto__);
});
/**
...
}catch (e11427){var _e__10708__auto__ = e11427;
...
var G__11428 = (obj[cljs.core.first.call(null,path)]);
var G__11429 = cljs.core.rest.call(null,path);
obj = G__11428;
path = G__11429;
continue;
} else {
...
var _STAR_ = (function (accum,p__11430){
var vec__11431 = p__11430;
var bit = cljs.core.nth.call(null,vec__11431,(0),null);
var protocol = cljs.core.nth.call(null,vec__11431,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11434){
var vec__11435 = p__11434;
var ns = cljs.core.nth.call(null,vec__11435,(0),null);
var name = cljs.core.nth.call(null,vec__11435,(1),null);
var selector = cljs.core.nth.call(null,vec__11435,(2),null);
...
var post_process = (function (p__11439){
var vec__11440 = p__11439;
var munged_name = cljs.core.nth.call(null,vec__11440,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11440,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11438_SHARP_){
return (obj[cljs.core.first.call(null,p1__11438_SHARP_)]);
}),sorted_matches);
