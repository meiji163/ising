...
var G__11445 = devtools.prefs.pref.call(null,v);
v = G__11445;
continue;
} else {
return v;
...
}catch (e11446){var _e__10708__auto__ = e11446;
return false;
}})();
...
}catch (e11448){var _e__10708__auto__ = e11448;
return false;
}})();
...
}catch (e11450){var _e__10708__auto__ = e11450;
return false;
}}
}
});
...
var vec__11452 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11452,(0),null);
var name = cljs.core.nth.call(null,vec__11452,(1),null);
...
return cljs.core.some.call(null,(function (p1__11455_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11455_SHARP_);
}),template);
});
